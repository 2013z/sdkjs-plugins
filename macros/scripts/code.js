...
(function(window, undefined){
	...
	{
		document.getElementById("button_new").innerHTML = window.Asc.plugin.tr("新建");
		document.getElementById("button_delete").innerHTML = window.Asc.plugin.tr("删除");
        document.getElementById("button_rename").innerHTML = window.Asc.plugin.tr("重命名");
        document.getElementById("button_autostart").innerHTML = window.Asc.plugin.tr("自动运行");
        document.getElementById("button_run").innerHTML = window.Asc.plugin.tr("运行");
        document.getElementById("rename_ok").innerHTML = window.Asc.plugin.tr("Ok");
        document.getElementById("rename_cancel").innerHTML = window.Asc.plugin.tr("取消");
        document.getElementById("input_error_id").title = window.Asc.plugin.tr("标题");
    };
            ...
            window.addEventListener("contextmenu", function(e) {
                ...
                if (className && -1 != className.indexOf("macros"))
                {
                    ...
                    document.getElementById("menu_autostart_id").innerHTML = window.Asc.plugin.tr(
                        Content.macrosArray[window.CustomContextMenu.macrosIndex].autostart ? "取消自动运行" : "制作自动运行");
